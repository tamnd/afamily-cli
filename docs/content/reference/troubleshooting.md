...
Most of these come down to network reality or how afamily serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

afamily rate-limits like any public site. afamily already paces
...
Where a surface is gated, afamily reads a cookie or token you supply
...
`afamily`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what afamily actually did
