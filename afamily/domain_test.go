...
// HTTP behaviour is covered in afamily_test.go.
...
func TestDomainInfo(t *testing.T) {
	...
	if info.Identity.Binary != "afamily" {
		t.Errorf("Identity.Binary = %q, want afamily", info.Identity.Binary)
	}
}
...
func TestHostWiring(t *testing.T) {
	...
	if want := "afamily://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("afamily", "about")
	if err != nil || got.String() != "afamily://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want afamily://page/about", got.String(), err)
	}
}
